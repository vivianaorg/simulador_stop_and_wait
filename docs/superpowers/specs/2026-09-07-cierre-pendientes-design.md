...
|---|---|---|---|
| 2026-09-07 | 4 | **El paso 3 depende del usuario** (probar a mano), y el 4 no dependía del 3 | Se adelantó el paso 4. El orden 1 → 2 seguía siendo obligatorio y se respetó; el 3 queda como único paso abierto |
| 2026-09-07 | 3 | **Petición nueva del usuario mientras el paso 3 seguía abierto**: ruido de ráfaga determinista, medido en milisegundos y disparado a mano, más un bloque de transferencia en la calculadora. Al diseñarlo apareció que el proyecto tiene **dos tamaños de trama que no se hablan** — el `frameBits` de los tiempos y el `payloadBytes` de la trama real, fijo a 8 | **No se abre ficha en `06`.** Es trabajo nuevo, no un pendiente del cierre: sale del cierre y va con spec propia, [`2026-09-07-rafaga-de-ruido-y-transferencia-design.md`](2026-09-07-rafaga-de-ruido-y-transferencia-design.md). El paso 3 sigue siendo lo único abierto del cierre y no se toca hasta que el usuario lo pruebe. Si el tiempo hasta el 2026-09-09 aprieta, el cierre tiene prioridad sobre la funcionalidad nueva |
...
| 2026-09-08 | 3 | **Segunda petición del usuario con el paso 3 todavía abierto, la víspera de la entrega**: desarrollo más granular en la calculadora (conversiones de unidad visibles, fórmulas apiladas como en un libro, notación científica), fichero y trama como entradas de primera clase, y quitar la probabilidad de error **de la calculadora, no del simulador**. Al verificar el motor antes de diseñar —12 635 comprobaciones sobre valores aleatorios, cero fallas de cálculo— aparecieron seis defectos de presentación y de atribución, entre ellos que el preset «LAN 10 Mbps · 1 km» **no es del libro** y que se llama BDP a la ventana `2BD+1` | **No se abre ficha en `06`.** Se le expuso el calendario al usuario y decidió seguir: sale del cierre y va con spec propia, [`2026-09-08-calculadora-granular-design.md`](2026-09-08-calculadora-granular-design.md). El paso 3 sigue siendo lo único abierto del cierre. El plan ordena primero las correcciones y después lo cosmético, de modo que si hay que parar a mitad quede fuera lo decorativo, no lo incorrecto |
